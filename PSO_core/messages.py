...
#------> GENERAL INFORMATION
FIND_DESIGN = "the model exists, incializating the optimization process"
NO_ERR = ", no errors"
...
REQUES_Y_LABEL = "Enter the axis y label: "
...
DW_ONE_COMPLETE_EJECUTION = "Draw one complete ejecution"
DW_ONE_REPORTS_COMPARITIONS = "Draw one reports comparitions"
...
CHANGE_SUCESSFULL = "Change successfull!"
